...
class Tent(nn.Module):
    ...
    def __init__(self, model, args):
        ...
        self.model, self.optimizer = prepare_tent_model_and_optimizer(model, args)
...
def prepare_tent_model_and_optimizer(model, args):
    model = configure_model(model)
    params, _ = collect_params(model)
    #hardcoded lr and momentum for ImageNet
