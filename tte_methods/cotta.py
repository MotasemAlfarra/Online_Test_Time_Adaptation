...
import tte_methods.cotta_transforms as my_transforms
...
class CoTTA(nn.Module):
    ...
    def __init__(self, model, args):#, optimizer, steps=1, episodic=False):
        ...
        self.model, self.optimizer = prepare_cotta_model_and_optimizer(model, args)
        self.steps=1        
        self.episodic=False
...
def prepare_cotta_model_and_optimizer(model, args):
